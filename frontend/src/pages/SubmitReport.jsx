...
const LeftSidebar = () => (
    <div style={{ width: '260px', borderRight: '1px solid var(--border)', padding: '2rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', background: 'var(--bg-dark)', height: 'calc(100vh - 70px)', position: 'sticky', top: '70px', overflowY: 'auto', zIndex: 100 }}>
        ...
        <button style={{ background: 'rgba(0,240,255,0.05)', color: 'var(--primary)', border: '1px solid var(--primary-low)' }} className="nav-item"><FileText size={18} /> My Reports</button>
        <Link to="/bounties" style={{ textDecoration: 'none' }}>
            <button style={{ background: 'rgba(0,240,255,0.05)', color: 'var(--primary)', border: '1px solid var(--primary-low)' }} className="nav-item"><Shield size={18} /> Explore Bounties</button>
        </Link>
        <button style={{ background: 'rgba(0,240,255,0.05)', color: 'var(--primary)', border: '1px solid var(--primary-low)' }} className="nav-item"><Trophy size={18} /> Leaderboard</button>

        <div style={{ marginTop: 'auto', paddingTop: '2rem' }}>
            <Link to="/profile" style={{ textDecoration: 'none' }}>
                <button style={{ background: 'rgba(0,240,255,0.05)', color: 'var(--primary)', border: '1px solid var(--primary-low)' }} className="nav-item"><Settings size={18} /> Settings</button>
            </Link>
        </div>
    </div>
);
    ...
    <div style={{ marginBottom: '2rem' }}>
        ...
        {tab === 'write' ? (
            <textarea
                ...
                style={{ minHeight: '200px', fontFamily: 'var(--font-mono)', fontSize: '0.95rem', lineHeight: 1.6 }}
                value={value}
...
export default function SubmitReport() {
    ...
    return (
        <div style={{ display: 'flex', minHeight: 'calc(100vh - 80px)', background: 'var(--bg-dark)' }}>
                    ...
                    <section className="glass-panel" style={{ padding: '2.5rem', borderLeft: '4px solid #10b981' }}>
                        ...
                        <div style={{ marginBottom: '3rem' }} className="form-group">
                            ...
                            <input
                                ...
                                style={{ fontSize: '1.2rem', fontWeight: 'bold', padding: '1.5rem' }}
                            />
                            <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '0.6rem', marginLeft: '4px' }}>A concise descriptive title for the vulnerability.</p>
                        </div>
            ...
            <div style={{ width: '360px', padding: '2.5rem', background: 'var(--bg-card)', borderLeft: '1px solid var(--border)', position: 'sticky', top: '70px', height: 'calc(100vh - 70px)', overflowY: 'auto' }}>
